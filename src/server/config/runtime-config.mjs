...
export function loadRuntimeConfig(env = process.env) {
  ...
  const config = {
    ...
    request_timeout_ms: envInteger(env.REQUEST_TIMEOUT_MS, 65_000, { minimum: 1_000, maximum: 300_000, name: "REQUEST_TIMEOUT_MS" }),
    ...
    deepseek_timeout_ms: envInteger(env.DEEPSEEK_TIMEOUT_MS, 60_000, { minimum: 1_000, maximum: 300_000, name: "DEEPSEEK_TIMEOUT_MS" }),
    ...
    deepseek_max_tokens: envInteger(env.DEEPSEEK_MAX_TOKENS, 1_200, { minimum: 1, maximum: 100_000, name: "DEEPSEEK_MAX_TOKENS" }),
    ...
    zhihu_timeout_ms: envInteger(env.ZHIHU_TIMEOUT_MS, 15_000, { minimum: 1_000, maximum: 120_000, name: "ZHIHU_TIMEOUT_MS" }),
